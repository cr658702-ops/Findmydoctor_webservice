...
import com.ravi.service.AppointmentService;
...
public class AppointmentController {
	...
	public String checkAppointment(@RequestBody Appointments	appointment) {
		appointment.setStatus("Pending");
		String r=appointmentService.checkAppointment(appointment);
		return r;
	}
