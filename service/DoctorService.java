...
import com.ravi.repo.DoctorDetailsRepo;
import com.ravi.repo.DoctorNotAvailRepo;
import com.ravi.repo.DoctorOnlineRepo;
...
public class DoctorService {
	...
	public List<Doctor> getDoctors(String state, String city, String speciality) {
		return doctorRepo.findByStateAndCityAndSpecialityAndStatus(state, city, speciality,"Activate");
	}
